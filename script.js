...
// --- 1. EMBEDDED MEGA DATABASE (No Fetch Needed) ---
const MEGA_DB = [
  ...
  { "name": "masala dosa", "variants": [ { "name": "Masala Dosa", "cal": 380, "unit": "pc", "type": "bad", "desc": "Potato & Oil" } ] },
  { "name": "vada", "variants": [ { "name": "Medu Vada", "cal": 150, "unit": "pc", "type": "bad", "desc": "Fried" } ] },
  { "name": "puri", "variants": [ { "name": "Puri Bhaji (3pcs)", "cal": 450, "unit": "plate", "type": "bad", "desc": "Heavy" } ] },
  ...
  { "name": "chicken", "variants": [ { "name": "Grilled Chicken", "cal": 165, "unit": "breast", "type": "good", "desc": "Lean" }, { "name": "Butter Chicken", "cal": 450, "unit": "bowl", "type": "bad", "desc": "Creamy" }, { "name": "Chicken Biryani", "cal": 350, "unit": "cup", "type": "bad", "desc": "Rich" } ] },
  { "name": "chicken biryani", "variants": [ { "name": "Chicken Biryani", "cal": 350, "unit": "cup", "type": "bad", "desc": "Rich" } ] },
  ...
  { "name": "noodles", "cal": 350, "unit": "plate", "type": "bad", "desc": "Oily" },
  { "name": "burger", "cal": 400, "unit": "pc", "type": "bad", "desc": "Fast Food" },
  { "name": "pizza", "cal": 250, "unit": "slice", "type": "bad", "desc": "Cheese" },
  { "name": "apple", "cal": 52, "unit": "pc", "type": "good", "desc": "Fruit" },
  { "name": "banana", "cal": 105, "unit": "pc", "type": "good", "desc": "Energy" },
  { "name": "gulab jamun", "cal": 150, "unit": "pc", "type": "bad", "desc": "Sweet" },
  { "name": "ice cream", "cal": 250, "unit": "scoop", "type": "bad", "desc": "Sweet" },
  { "name": "chocolate", "cal": 100, "unit": "bar", "type": "bad", "desc": "Sweet" },
  { "name": "f1 shake", "cal": 242, "unit": "glass", "type": "good", "desc": "Herbalife" },
  { "name": "afresh", "cal": 4, "unit": "cup", "type": "good", "desc": "Energy" }
];
...
function updateUI() {
    ...
    if (diff <= 0) {
        document.getElementById('daysToGoal').innerText = "Goal Reached! 🎉";
    } else {
        ...
        document.getElementById('daysToGoal').innerText = daysLeft > 365 ? "> 1 Year" : daysLeft + " Days";
    }
...
function renderMeals() {
    ...
    if (currentMenuMode === 'user') {
        ...
        // Coach view simplified for brevity
